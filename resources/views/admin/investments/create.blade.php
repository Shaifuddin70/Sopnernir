<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('New investment') }}</h2>
    </x-slot>
                ...
                <form method="post" action="{{ route('admin.investments.store') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            <p class="mt-1 text-xs text-gray-500">{{ __('Optional: first month this pool pays profit (defaults to the month you create this record).') }}</p>
                        ...
                        <div>
                            ...
                            <x-text-input id="default_monthly_rate_pct" name="default_monthly_rate_pct" type="text" class="mt-1 block w-full" value="{{ old('default_monthly_rate_pct', '1.5') }}" required />
                        ...
                        <div class="rounded-md border border-gray-200 p-4 space-y-2">
                            ...
                            <label class="inline-flex items-start gap-2 cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" class="mt-1 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('is_active', true)) />
                    ...
                    <div class="flex items-center gap-2 mt-6">
                        ...
                        <x-action-button :href="route('admin.investments.index')" variant="secondary" class="text-sm">{{ __('Cancel') }}</x-action-button>
                    </div>
                </form>
            </div>
        </div>
